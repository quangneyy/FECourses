...
import {
  getListCourses,
  getListCoursesPage,
} from "../../redux/action/GetListCourses";
...
const Course = (props) => {
  ...
  const {arrCoursesPage} = useSelector(state => state.CoursesReducer)
          ...
          <div className="courses__content__cover">
            ...
            <div className="courses__right">
              ...
              <div className="list__courses">
                {chekcFill
                  ? arrCourses2.map((x, index) => {
                      return <Card item={x} key={index} />;
                    })
                  : openSearch ? searchList.map((item, index) => {
                    return <Card item={item} key={index} />;
                  }) :
                  arrCoursesPage ?
                  arrCoursesPage.map((item, index) => {
                    return <Card item={item} key={index} />;
                  }) 
                : <Fragment></Fragment>
                  } 
